  ...
  const [behaviors, setBehaviors] = useState([
    {
      ...
      description: '우리는 항상 고객을 최우선으로 생각하며 시작합니다','무엇이 고객을 성공하게 만드는지 이해합니다', '고객에 대한 통찰을 가치 있는 솔루션으로 전환합니다','팀 간의 협력을 통해 탁월한 고객 경험을 제공합니다',
      skills: ['균형적 성과관리', '고객가치 중심의 마인드셋', '자원 배분', '심리적 안정감 형성', '데이터 기반 의사결정', '고객 중심 커뮤니케이션'],
      rating: 3,
